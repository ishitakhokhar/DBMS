...
SELECT REGION,COUNT(DISTINCT PRODUCT),PRODUCT FROM SALES_DATA GROUP BY REGION,PRODUCT HAVING (COUNT(PRODUCT)-COUNT(DISTINCT PRODUCT))>=1
SELECT REGION,COUNT(PRODUCT),PRODUCT FROM SALES_DATA GROUP BY  PRODUCT,REGION HAVING COUNT(PRODUCT) >1

--SELECT TOP 1 SALES_AMOUNT FROM SALES_DATA ORDER BY SALES_AMOUNT DESC
--5
